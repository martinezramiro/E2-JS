...
idImpares.forEach ((pizza) => {
  console.log(`La ${pizza.nombre} tiene el id impar.`);
});*/

/*b) Responder: ¿Hay alguna pizza que valga menos de $600?*/

/*const menosValor = pizzas.some ((pizza) => {
...
/*const pizzaPrecio = pizzas.filter ((pizza) => {
...
pizzaPrecio.forEach ((pizza) => {
  console.log(
    `La ${pizza.nombre} tiene los siguientes ingredientes: ${pizza.ingredientes}.`
  );
})*/
